namespace WebApiAutores.Middlewares
{
    ...
    {
        public static IApplicationBuilder UseLoguearRespuestaHTTPMiddleware(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<LoguearRespuestaHTTPMiddleware>();
        }
    }
